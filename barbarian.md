...
| Level | Icon | Feature |
|-------|------|---------|
| 1 | ![Rage](assets/rage_icon.webp) | Rage |
| 2 | ![Reckless Attack](assets/reckless_icon.webp) ![Always Ready](assets/danger_sense_icon.webp) | Reckless Attack + Always Ready |
| 5 | ![Extra Attack](assets/extra_attack_icon.webp) | Extra Attack |
| 7 | ![Primal Instinct](assets/feral_instinct_icon.webp) | Primal Instinct |
| 9 | ![Enhanced Critical](assets/brutal_critical_icon.webp) | Enhanced Critical |
| 11 | ![Death Warding Rage](assets/relentless_rage_icon.webp) | Death Warding Rage |
| 18 | ![Indomitable Might](assets/indomitable_might_icon.webp) | Indomitable Might |
| 20 | ![Unrivaled Ability](assets/primal_champion_icon.webp) | Unrivaled Ability |

### ![](assets/rage_icon.webp) Rage *(L1 — No energy, self-target)*
Enter a barbarian rage for **10 turns**, gaining:
- **+2 bonus damage** on all attacks
- **Resistance to bludgeoning, piercing, and slashing damage**
- **Advantage on Strength checks and saving throws**

### ![](assets/reckless_icon.webp) Reckless Attack *(L2 — Melee)*
...
### ![](assets/danger_sense_icon.webp) Always Ready *(L2 — Passive)*
...
### ![](assets/feral_instinct_icon.webp) Primal Instinct *(L7 — Passive)*
Permanent **advantage on initiative rolls**. You almost always act first.

### ![](assets/brutal_critical_icon.webp) Enhanced Critical *(L9 — Passive)*
...
### ![](assets/taunting_icon.webp) Taunt *(L2+, No energy)*
...
|----------|------|---------|--------|
| Heavenfire | ![](assets/storm_melee_heat_icon.webp) | Storm Melee: Heat | Melee attacks deal extra **1d6 heat** damage (2d6 at L14+). |
| Lust | ![](assets/storm_melee_cold_icon.webp) | Storm Melee: Cold | Melee attacks deal extra **1d6 cold** damage (2d6 at L14+) and may **Slow** target (Con save). |
| Chaos | ![](assets/storm_melee_poison_icon.webp) | Storm Melee: Poison | Melee attacks deal extra **1d6 poison** damage (2d6 at L14+) and may **Poison** target (Con save). |
...
| Affinity | Icon | Ability | Effect |
|----------|------|---------|--------|
| Heavenfire | ![](assets/storm_aura_heat_icon.webp) | Storm Aura: Heat | Enemies with highest initiative take **1d6 heat** damage per turn (2d6 at L17+); all allies gain heat resistance. |
| Lust | ![](assets/storm_aura_cold_icon.webp) | Storm Aura: Cold | Enemies with highest initiative take **1d6 cold** damage per turn (2d6 at L17+), may Slow; all allies gain cold resistance. |
| Chaos | ![](assets/storm_aura_poison_icon.webp) | Storm Aura: Poison | Enemies with highest initiative take **1d6 poison** damage per turn (2d6 at L17+), may Poison; all allies gain poison resistance. |
...
|-------|------|------|-------------|
| L4 | ![](assets/storm_herald_melee_heat_icon.webp) ![](assets/storm_herald_melee_cold_icon.webp) ![](assets/storm_herald_melee_poison_icon.webp) | Storm Herald Melee | Affinity-gated. Scales 1d6 → 2d6 → 3d6 → 4d6 at levels 8, 12, 16. |
| L8 | ![](assets/storm_herald_aura_heat_icon.webp) ![](assets/storm_herald_aura_cold_icon.webp) ![](assets/storm_herald_aura_poison_icon.webp) | Storm Herald Aura | Affinity-gated. Scales 1d6 → 2d6 → 3d6 at levels 12, 16. |
