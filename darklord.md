...
|------|--------|-------|--------|----------|---------|
| ![](assets/summon_raven_icon.webp) | Summon Raven | 2 | 2 | **Raven** — fragile, fast familiar (high initiative, low HP). | Raking Peck (1d4 physical). |
| ![](assets/summon_lesser_demon_icon.webp) | Summon Lesser Demon | 5 | 3 | **Lesser Demon** — a clawed melee brute. | Demonic Claws (1d8 physical). |
| ![](assets/summon_demon_elite_icon.webp) | Summon Demon Elite | 9 | 5 | **Demon Elite** — durable and versatile. | Savage Rend (2d6 physical) + Infernal Bolt (2d6 heat). |
| ![](assets/summon_behemoth_icon.webp) | Summon Behemoth | 13 | 7 | **Behemoth** — enormous HP, a slow wall of muscle. | Crushing Slam (2d10 physical). |
| ![](assets/summon_hellhound_icon.webp) | Summon Hellhound | 13 | 6 | **Hellhound** — the fire-specialist capstone. | Searing Bite (2d8 heat) + Hellfire Breath (2d6 heat, applies **Hot**). |
